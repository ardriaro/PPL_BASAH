...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../css/services/konfirmasiAlamat.css" />
  ...
  <body>
        ...
        <div class="d-flex reverse">
          <div class="dropdown-center">
            ...
            <li><a class="dropdown-item" href="../profile.php">Profil</a></li>
              ...
              <li><a class="dropdown-item" href="../homepage.php">Log out</a></li>
            </ul>
          </div>
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="bantuan.php">Bantuan</a>
              </li>
              <li class="nav-item">
    ...
    <div class="container-fluid text-center section">
      <div class="row justify-content-md-center">
          ...
          <div class="col-2">
            <a href="">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-2-circle-fill" viewBox="0 0 16 16" style="color: #23AA49;">
    ...
    <h1 class="header1">Apakah Alamatmu Sudah Benar?</h1>
    ...
    <section class="container section2">
      ...
      <div class="row">
        <div class="col-9">
          <p>
            <b>Label Alamat :</b> Rumah <br>
            <b>Alamat Lengkap :</b> Ar - Razzaq kost putra Purwokerto JI.M Yamin VII RT 06/04 Karangpucung <br>
            <b>Catatan :</b> Dekat dengan kantor samsat, seberang warung sate kambing pak kumis
          </p>
    ...
    <div class="container-xxl d-flex justify-content-center my-5">
      <a href="agenBerangkat.php">
        <button type="button" class="btn btn-success btn-lg">Setuju</button>        
      </a>
    </div>
