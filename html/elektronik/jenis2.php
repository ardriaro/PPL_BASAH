  ...
  <!-- End Navbar -->
        ...
        <section class="container">
          <div class="content row">
              ...
              <div>
                <p>
                  Sampah elektronik mencakup berbagai jenis perangkat yang mengandung komponen listrik atau elektronik. Berikut adalah beberapa jenis umum sampah elektronik:
                </p>
                <ol>
                  <li>
                    <b>Komputer dan Laptop: </b>Termasuk CPU, monitor, keyboard, mouse, dan perangkat keras komputer lainnya.

                  </li>
                  <li>
                    <b>Telepon Seluler dan Perangkat Komunikasi: </b> Ponsel pintar, telepon seluler, smartphone, dan perangkat komunikasi portabel lainnya.

                  </li>
                  <li>
                    <b>Perangkat Audio-Visual: </b> TV, pemutar DVD, pemutar Blu-ray, kamera digital, kamera video, dan perangkat audio lainnya.


                  </li>
                  <li>
                    <b>Perangkat Rumah Tangga Elektronik: </b> Termasuk mesin cuci, kulkas, oven microwave, pemanggang roti, dan perangkat lainnya dengan komponen elektronik.


                  </li>
                  <li>
                    <b>Perangkat Elektronik Kecil: </b> Kalkulator, mesin tik, printer, pemindai, dan perangkat elektronik kecil lainnya.
                  </li>
                  <li>
                    <b>Perangkat Penyimpanan Data:  </b> Hard disk drive (HDD), solid-state drive (SSD), USB flash drive, dan perangkat penyimpanan data lainnya.


                  </li>
                  <li>
                    <b>Perangkat Jaringan dan Telekomunikasi: </b> Router, modem, switch, dan perangkat jaringan lainnya.

                  </li>
                  <li>
                    <b>Perangkat Elektronik Konsumen: </b> Earphone, headphone, remote control, dan perangkat elektronik konsumen lainnya.


                  </li>
                  <li>
                    <b>Perangkat Elektronik Medis: </b> Alat pengukur tekanan darah elektronik, termometer digital, dan perangkat medis elektronik lainnya.



                  </li>
                  <li>
                    <b>Perangkat Elektronik Militer dan Industri: </b> Komponen elektronik yang digunakan dalam aplikasi militer dan industri.
                ...
                <p>
                  Penting untuk mencatat bahwa setiap jenis sampah elektronik dapat mengandung berbagai material berbahaya seperti merkuri, kadmium, timbal, dan berbagai senyawa organik yang perlu dikelola dengan hati-hati dalam proses daur ulang atau pemusnahan. Daur ulang dan pengelolaan yang benar dari sampah elektronik penting untuk mengurangi dampak negatifnya terhadap lingkungan dan kesehatan manusia.
                </p>
              </div>
              </div>
          </div>
