  ...
  <!-- End Navbar -->
        ...
        <section class="container">
          <div class="content row">
              ...
              <div>
                <p>
                  Sampah organik adalah jenis sampah yang berasal dari bahan-bahan yang dapat terurai alami. Berikut adalah beberapa jenis sampah organik yang umum ditemui:


                </p>
                <ol>
                  <li>
                    <b>Sisa Makanan: </b>Sisa-sisa makanan, seperti sayuran yang busuk, kulit buah, sisa daging, dan makanan yang sudah kadaluarsa.

                  </li>
                  <li>
                    <b>Serpihan Tumbuhan: </b> Daun kering, ranting, rumput, dan bahan organik lainnya yang berasal dari tanaman.
                  </li>
                  <li>
                    <b>Kertas dan Karton: </b> Sampah organik juga dapat mencakup kertas dan karton yang terurai alami, seperti kertas makanan, kertas tisu, dan kardus yang tidak terkontaminasi bahan berbahaya.

                  </li>
                  <li>
                    <b>Bahan Daur Ulang Organik: </b> Produk-produk yang dapat didaur ulang secara organik, seperti kertas daur ulang, kardus daur ulang, dan produk kertas lainnya.

                  </li>
                  <li>
                    <b>Sampah Dapur: </b> Bahan organik yang dihasilkan dari kegiatan memasak, seperti kulit sayuran, sisa bahan makanan, dan serpihan dapur lainnya.
                  </li>
                  <li>
                    <b>Sampah Taman:  </b> Limbah organik dari kegiatan berkebun, seperti dedaunan, ranting, dan tanaman yang sudah mati.

                  </li>
                  <li>
                    <b>Sampah Hewan Peliharaan: </b> Kotoran hewan peliharaan, seperti kotoran kucing atau anjing, juga termasuk dalam kategori sampah organik.

                  </li>
                  <li>
                    <b>Bahan Organik Lainnya: </b> Bahan-bahan organik lainnya yang dapat terurai, seperti kain yang terbuat dari serat alami, jerami, dan produk-produk yang terbuat dari bahan organik.
