    ...
    <div class="row justify-content-center">
      <div class="col-xl-5">
        <div class="card card-body p-4 p-md-5">
          <!-- Form untuk Menyimpan atau Mengupdate Alamat -->
          <form class="formulir" action="otiwi.php" method="post">
            <div class="form-outline">
              <input type="text" name="label" id="firstName" class="form-control" placeholder="Label Alamat" />
              <textarea name="alamat" class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Alamat Lengkap"></textarea>
              <input type="text" name="catatan" id="firstName" class="form-control" placeholder="Catatan" />
              <input type="hidden" name="action" value="simpan"> <!-- Menyimpan aksi yang akan dilakukan -->
              <button type="submit" class="btn">Simpan Alamat</button>
            </div>
          </form>

          <!-- Form untuk Memilih dan Mengupdate Alamat yang Sudah Ada -->
          <form class="formulir" action="otiwi.php" method="post">
            <div class="form-outline">
              <label for="selectAlamat">Pilih Alamat yang Ingin Diupdate:</label>
              <select name="selectedAlamat" id="selectAlamat" class="form-control">
                <!-- Ambil daftar alamat dari database dan tampilkan sebagai opsi -->
                <option value="1">Alamat 1</option>
              ...
              <textarea name="alamat" class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Alamat Lengkap"></textarea>
              <input type="text" name="catatan" id="firstName" class="form-control" placeholder="Catatan" />
              <input type="hidden" name="action" value="update"> <!-- Menyimpan aksi yang akan dilakukan -->
              <button type="submit" class="btn">Update Alamat</button>
            </div>
          </form>
        </div>
      </div>
