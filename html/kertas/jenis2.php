        ...
        <section class="container">
          <div class="content row">
              ...
              <div>
                ...
                <ol>
                  <li>
                    <b>Kertas daur ulang: </b> Kertas ini dibuat dari serat kertas bekas yang telah diolah kembali. Proses daur ulang ini mengurangi penggunaan bahan baku baru dan membantu mengurangi limbah kertas.
                  </li>
                  <li>
                    <b>Kertas surat daur ulang: </b> Jenis kertas ini digunakan untuk menulis surat atau dokumen. Terbuat dari serat kertas bekas yang diolah ulang, kertas surat daur ulang memiliki kualitas yang baik dan cocok untuk keperluan tulisan dan cetakan.
                  </li>
                  <li>
                    <b>Kertas koran daur ulang: </b> Kertas ini dibuat dari serat kertas bekas koran yang telah diolah ulang. Biasanya digunakan untuk mencetak koran baru atau sebagai bahan untuk pembuatan kemasan.
                  </li>
                  <li>
                    <b>Kertas karton daur ulang: </b> Kertas karton daur ulang merupakan kertas tebal yang digunakan untuk pembuatan kotak atau wadah lainnya. Biasanya terbuat dari serat kertas bekas yang diolah ulang. Kertas karton daur ulang memiliki kekuatan dan daya tahan yang baik.
                  </li>
                  <li>
                    <b>Kertas buku daur ulang: </b> Jenis kertas ini digunakan untuk membuat buku atau majalah. Serat kertas bekas diolah ulang menjadi kertas buku daur ulang, yang memiliki tekstur yang baik untuk mencetak teks dan gambar.
                  </li>
                  <li>
                    <b>Kertas kemasan daur ulang: </b> Kertas kemasan daur ulang digunakan untuk membuat kotak makanan, kantong belanja, atau bungkus produk lainnya. Terbuat dari serat kertas bekas yang telah diolah ulang, kertas ini membantu mengurangi penggunaan plastik dalam kemasan.
                  </li>
                </ol>
              </div>
              </div>
