...
<body>
  ...
  <section class="container" style="background-color: white;">
    <div class="content">
      <img src="../assets/berita tiga.png" alt="">

      <p style="font-family: 'Jost', sans-serif; margin-top: 30px; font-size: 1.5rem; text-indent: 1rem; text-align: justify;">
      Guna mengoptimalkan potensi sekaligus memberikan edukasi tentang daur ulang sampah menjadi bentuk usaha kreatif dan inovatif, Pemko Medan melalui Bagian Sumber Daya Alam (SDA) Setdako menyelenggarakan Sosialisasi Usaha Kreatif dan Inovatif Pengelolaan Sampah Daur Ulang di Kota Medan. 
      </p>
